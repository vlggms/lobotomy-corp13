...
/atom/movable/screen/plane_master/extra_visual_effects
...
/atom/movable/screen/plane_master/extra_visual_effects/backdrop(mob/M)
	var/mob/living/carbon/human/H = M
	var/list/damagenumberroles = list("Manager", "Sephirah")
	if(H?.mind?.assigned_role in damagenumberroles)
		alpha = 255
	else
