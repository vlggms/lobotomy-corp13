...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["see_typing_indicator"] , see_typing_indicator)
	...
	see_typing_indicator = sanitize_integer(see_typing_indicator, FALSE, TRUE, initial(see_typing_indicator))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["see_typing_indicator"], see_typing_indicator)
