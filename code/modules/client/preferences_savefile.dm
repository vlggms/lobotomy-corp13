...
/datum/preferences/proc/load_preferences()
	...
	READ_FILE(S["auxiliary_console"], auxiliary_console)
	...
	auxiliary_console = sanitize_inlist(auxiliary_console, GLOB.allowed_auxiliary_console_tgui, initial(auxiliary_console))
...
/datum/preferences/proc/save_preferences()
	...
	WRITE_FILE(S["auxiliary_console"], auxiliary_console)
