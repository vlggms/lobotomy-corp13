...
/obj/item/detective_scanner/attack_self(mob/user)
	...
	self_mode(user) // TEGUSTATION EXPANDED DETECTIVE TOOLS PR Surrealistik Oct 2019
...
/obj/item/detective_scanner/proc/PrintReport()
	...
	if(ismob(loc))
		var/mob/M = loc
		M.put_in_hands(P)
		to_chat(M, "<span class='notice'>Report printed.</span>") // TEGUSTATION DETECTIVE LOCKER PR Surrealistik April 2020

	// Clear the logs
	//log = list() // TEGUSTATION DETECTIVE LOCKER PR Surrealistik April 2020
	scanning = 0

/obj/item/detective_scanner/afterattack(atom/A, mob/user, params)
	. = ..()
	//scan(A, user)
	attack_mode(A, user) // TEGUSTATION EXPANDED DETECTIVE TOOLS PR Surrealistik Oct 2019
	return FALSE
...
/obj/item/detective_scanner/proc/scan(atom/A, mob/user)
	...
	if(!scanning)
		...
		if(length(fingerprints))
			//sleep(30) // TEGUSTATION EXPANDED DETECTIVE TOOLS PR Surrealistik Oct 2019; eliminating needless delays.
		...
		// Blood
		if (length(blood))
			//sleep(30) // TEGUSTATION EXPANDED DETECTIVE TOOLS PR Surrealistik Oct 2019
