...
/obj/item/clothing/head/ego_hat/ensemble/philip
	name = "Unspeaking"
	desc = "Having my happiness taken away doesn't always mean that sadness has to fill that space. I haven't become intrinsically unhappier. I've simply returned to a past state, back when I hadn't realized such emotions."
