...
/obj/item/clothing/accessory/fixer_badge/attack_self(mob/user)
	if(prob(1))
		user.say("Nothing between me and a payday!", forced = "association badge")
	user.visible_message("<span class='notice'>[user] shows [user.p_their()] association badge.</span>", "<span class='notice'>You show your association badge.</span>")
