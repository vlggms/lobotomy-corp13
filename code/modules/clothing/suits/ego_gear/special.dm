...
/obj/item/clothing/suit/armor/ego_gear/he/crumbling_armor
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = -100, FIRE = 30) // -10
...
/obj/item/clothing/suit/armor/ego_gear/despair_nihil
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 80, BLACK_DAMAGE = 60, PALE_DAMAGE = 80, FIRE = 30) // 280
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/hatred_nihil
	...
	icon_state = "hate"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 70, BLACK_DAMAGE = 80, PALE_DAMAGE = 60, FIRE = 35) // 280
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 80,
...
/obj/item/clothing/suit/armor/ego_gear/blind_rage_nihil
	...
	icon_state = "wrath"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 60, BLACK_DAMAGE = 80, PALE_DAMAGE = 80, FIRE = 30) // 280
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 80,
							PRUDENCE_ATTRIBUTE = 80,
...
/obj/item/clothing/suit/armor/ego_gear/goldrush_nihil
	...
	icon_state = "greed"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 70, PALE_DAMAGE = 70, FIRE = 40) // 280
	attribute_requirements = list(
