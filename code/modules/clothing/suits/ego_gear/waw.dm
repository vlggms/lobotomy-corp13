// WAW Armor should be kept at ~135 total armor.
...
/obj/item/clothing/suit/armor/ego_gear/hornet
	...
	icon_state = "hornet"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 30, BLACK_DAMAGE = 40, PALE_DAMAGE = 25) // 135
...
/obj/item/clothing/suit/armor/ego_gear/lamp
	...
	icon_state = "lamp"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 30, BLACK_DAMAGE = 60, PALE_DAMAGE = 25) // 135
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/correctional
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 0, BLACK_DAMAGE = 60, PALE_DAMAGE = 25) // 135
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/despair
	...
	icon_state = "despair"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 35, BLACK_DAMAGE = 20, PALE_DAMAGE = 60) // 135
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/hatred
	...
	icon_state = "hatred"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 60, PALE_DAMAGE = 25) // 135
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/oppression
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 20, BLACK_DAMAGE = 40, PALE_DAMAGE = 25) //
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 60
							)
...
/obj/item/clothing/suit/armor/ego_gear/totalitarianism
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 20, BLACK_DAMAGE = 50, PALE_DAMAGE = 25) // 135
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 60
							)
