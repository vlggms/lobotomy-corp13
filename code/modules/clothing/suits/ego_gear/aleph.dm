...
/obj/item/clothing/suit/armor/ego_gear/paradise
	...
	icon_state = "paradise"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 80, BLACK_DAMAGE = 80, PALE_DAMAGE = 80) // 280
...
/obj/item/clothing/suit/armor/ego_gear/justitia
	...
	icon_state = "justitia"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 60, BLACK_DAMAGE = 60, PALE_DAMAGE = 80) // 240
	attribute_requirements = list(
