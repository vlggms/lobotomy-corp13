...
/obj/item/clothing/suit/armor/ego_gear/realization/confessional
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 100, BLACK_DAMAGE = 40, PALE_DAMAGE = 40, FIRE = 25)	//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/prophet
	...
	icon_state = "prophet"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 80, BLACK_DAMAGE = 70, PALE_DAMAGE = 60, FIRE = 20)	//No ability.
...
/obj/item/clothing/suit/armor/ego_gear/realization/maiden
	...
	icon_state = "maiden"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 60, BLACK_DAMAGE = 80, PALE_DAMAGE = 50, FIRE = 30)	//No ability. 250
...
/obj/item/clothing/suit/armor/ego_gear/realization/wellcheers
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 50, FIRE = 40)	//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/comatose
	...
	desc = "...ZZZ..."
	icon_state = "comatose"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 80, BLACK_DAMAGE = 50, PALE_DAMAGE = 50, FIRE = 80)	//Defensive
...
/obj/item/clothing/suit/armor/ego_gear/realization/brokencrown
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 60, BLACK_DAMAGE = 50, PALE_DAMAGE = 50, FIRE = 35)	//Broken Crown
...
/obj/item/clothing/suit/armor/ego_gear/realization/mouth
	...
	icon_state = "mouth"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 60, BLACK_DAMAGE = 40, PALE_DAMAGE = 60, FIRE = 35)		//Defensive
...
/obj/item/clothing/suit/armor/ego_gear/realization/universe
	...
	icon_state = "universe"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 50, BLACK_DAMAGE = 80, PALE_DAMAGE = 60, FIRE = 20)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/death
	...
	icon_state = "death"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 40, BLACK_DAMAGE = 60, PALE_DAMAGE = 50, FIRE = 40)		//Melee with slow
...
/obj/item/clothing/suit/armor/ego_gear/realization/fear
	...
	icon_state = "fear"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 70, BLACK_DAMAGE = 70, PALE_DAMAGE = 10, FIRE = 40)		//Melee, makes weapon better
	flags_inv = null
...
/obj/item/clothing/suit/armor/ego_gear/realization/exsanguination
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 80, BLACK_DAMAGE = 60, PALE_DAMAGE = 50, FIRE = 30)			//No ability
...
/obj/item/clothing/suit/armor/ego_gear/realization/sakura_bloom
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 80, BLACK_DAMAGE = 40, PALE_DAMAGE = 50, FIRE = 30)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/stupor
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 30, BLACK_DAMAGE = 50, PALE_DAMAGE = 70, FIRE = 40)		//Defensive
...
/obj/item/clothing/suit/armor/ego_gear/realization/grinder
	...
	icon_state = "grinder"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 40, BLACK_DAMAGE = 60, PALE_DAMAGE = 60, FIRE = 35)		//Melee
...
/obj/item/clothing/suit/armor/ego_gear/realization/bigiron
	...
	icon_state = "big_iron"
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 50, BLACK_DAMAGE = 60, PALE_DAMAGE = 60, FIRE = 60)		//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/eulogy
	...
	icon_state = "eulogy"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 80, BLACK_DAMAGE = 80, PALE_DAMAGE = 40, FIRE = 15)
...
/obj/item/clothing/suit/armor/ego_gear/realization/ourgalaxy
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 60, BLACK_DAMAGE = 70, PALE_DAMAGE = 60, FIRE = 20)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/empathy
	...
	icon_state = "empathy"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 60, PALE_DAMAGE = 50, FIRE = 40)		//No ABility
...
/obj/item/clothing/suit/armor/ego_gear/realization/valor
	...
	icon_state = "valor"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 80, FIRE = 35)		//No ability
...
/obj/item/clothing/suit/armor/ego_gear/realization/home //This name would SO much easier if we didnt aleady USE HOMING INSTINCT AHHHHHHHHHHHHHHHHHHH
	...
	icon_state = "home"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 60, BLACK_DAMAGE = 80, PALE_DAMAGE = 50, FIRE = 20)		//Support
	flags_inv = HIDEGLOVES|HIDESHOES
...
/obj/item/clothing/suit/armor/ego_gear/realization/dimension_ripper
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 50, BLACK_DAMAGE = 60, PALE_DAMAGE = 50, FIRE = 35)		//Melee
...
/obj/item/clothing/suit/armor/ego_gear/realization/goldexperience
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 50, PALE_DAMAGE = 40, FIRE = 40)			//Melee
...
/obj/item/clothing/suit/armor/ego_gear/realization/quenchedblood
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 60, BLACK_DAMAGE = 40, PALE_DAMAGE = 80, FIRE = 25)		//Ranged
...
/obj/item/clothing/suit/armor/ego_gear/realization/lovejustice
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 50, BLACK_DAMAGE = 70, PALE_DAMAGE = 50, FIRE = 30)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/woundedcourage
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 40, BLACK_DAMAGE = 70, PALE_DAMAGE = 50, FIRE = 35)		//Melee
	flags_inv = HIDEJUMPSUIT | HIDEGLOVES | HIDESHOES
...
/obj/item/clothing/suit/armor/ego_gear/realization/crimson
	...
	icon_state = "crimson"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 50, BLACK_DAMAGE = 60, PALE_DAMAGE = 60, FIRE = 40)		//No Ability

/obj/item/clothing/suit/armor/ego_gear/realization/eyes
	name = "eyes of god"
	desc = "And the eyes of god spoke: You will be saved."
	icon_state = "eyes"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 60, BLACK_DAMAGE = 80, PALE_DAMAGE = 40, FIRE = 25)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/cruelty
	...
	icon_state = "cruelty"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 50, BLACK_DAMAGE = 70, PALE_DAMAGE = 50, FIRE = 40)		//No Ability
	flags_inv = HIDEJUMPSUIT|HIDEGLOVES|HIDESHOES
...
/obj/item/clothing/suit/armor/ego_gear/realization/bell_tolls
	...
	icon_state = "thirteen"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 50, BLACK_DAMAGE = 80, PALE_DAMAGE = 70, FIRE = 25)		//No Ability
...
/obj/item/clothing/suit/armor/ego_gear/realization/capitalism
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 70, BLACK_DAMAGE = 60, PALE_DAMAGE = 30, FIRE = 35)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/duality_yang
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 80, BLACK_DAMAGE = 40, PALE_DAMAGE = 70, FIRE = 20)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/duality_yin
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 40, BLACK_DAMAGE = 80, PALE_DAMAGE = 40, FIRE = 35)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/repentance
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 70, FIRE = 40)		//Healing
...
/obj/item/clothing/suit/armor/ego_gear/realization/nest
	...
	icon_state = "nest"
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 50, PALE_DAMAGE = 40, FIRE = 20)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/alcoda
	...
	icon_state = "coda"
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 100, BLACK_DAMAGE = 60, PALE_DAMAGE = 20, FIRE = 35)		//No Ability

/obj/item/clothing/suit/armor/ego_gear/realization/head
	name = "head of god"
	desc = "And the head of god spoke: You will be judged."
	icon_state = "head"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 80, FIRE = 25)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/shell
	...
	armor = list(RED_DAMAGE = 80, WHITE_DAMAGE = 60, BLACK_DAMAGE = 30, PALE_DAMAGE = 60, FIRE = 40)			//Melee
...
/obj/item/clothing/suit/armor/ego_gear/realization/laughter
	...
	icon_state = "laughter"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 50, BLACK_DAMAGE = 80, PALE_DAMAGE = 50, FIRE = 25)		//Support
...
/obj/item/clothing/suit/armor/ego_gear/realization/fallencolors
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 80, BLACK_DAMAGE = 80, PALE_DAMAGE = 30, FIRE = 20)		//Defensive
	var/canSUCC = TRUE
...
/obj/item/clothing/suit/armor/ego_gear/realization/farmwatch
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 70, BLACK_DAMAGE = 40, PALE_DAMAGE = 60, FIRE = 35)
...
/obj/item/clothing/suit/armor/ego_gear/realization/spicebush
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 70, BLACK_DAMAGE = 70, PALE_DAMAGE = 60, FIRE = 10)
