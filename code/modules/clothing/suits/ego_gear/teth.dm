...
/obj/item/clothing/suit/armor/ego_gear/teth/training
	...
	icon_state = "training"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 0, BLACK_DAMAGE = -40, PALE_DAMAGE = 0, FIRE = 20) // 0
...
/obj/item/clothing/suit/armor/ego_gear/teth/beak
	...
	icon_state = "beak"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 10, BLACK_DAMAGE = -20, PALE_DAMAGE = 0, FIRE = 15) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/horn
	...
	icon_state = "horn"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 20, BLACK_DAMAGE = -20, PALE_DAMAGE = 0, FIRE = 10) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/lutemia
	name = "dear lutemia"
	desc = "Your sadness, woes, cast them all aside."
	icon_state = "lutemia"
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 40, BLACK_DAMAGE = -20, PALE_DAMAGE = 0, FIRE = -20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/eyes
	...
	icon_state = "eyes"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -30, BLACK_DAMAGE = 20, PALE_DAMAGE = 0, FIRE = 15) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/daredevil
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = -50, FIRE = 15) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/noise
	name = "noise"
	desc = "This is a recording of the day we must never forget."
	icon_state = "noise"
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 0, FIRE = -20) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/sorrow
	name = "sorrow"
	desc = "You can't always see who needs you."
	icon_state = "sorrow"
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 30, BLACK_DAMAGE = 10, PALE_DAMAGE = 0, FIRE = -20)

/obj/item/clothing/suit/armor/ego_gear/teth/solitude
	name = "solitude"
	desc = "Conversation is meaningless."
	icon_state = "solitude"
	armor = list(RED_DAMAGE = -30, WHITE_DAMAGE = 30, BLACK_DAMAGE = 20, PALE_DAMAGE = 0, FIRE = -30)
...
/obj/item/clothing/suit/armor/ego_gear/teth/wrist
	...
	icon_state = "wrist"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = 30, BLACK_DAMAGE = -20, PALE_DAMAGE = 0, FIRE = 5)

/obj/item/clothing/suit/armor/ego_gear/teth/wedge
	name = "screaming wedge"
	desc = "One can assume that she is longing for someone."
	icon_state = "wedge"
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 30, BLACK_DAMAGE = 10, PALE_DAMAGE = -10, FIRE = -10)
...
/obj/item/clothing/suit/armor/ego_gear/teth/blossoms
	...
	icon_state = "blossoms"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 30, BLACK_DAMAGE = -30, PALE_DAMAGE = 0, FIRE = 10)
...
/obj/item/clothing/suit/armor/ego_gear/teth/cute
	...
	icon_state = "cute"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -20, BLACK_DAMAGE = 10, PALE_DAMAGE = 0, FIRE = 15) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/shy
	...
	icon_state = "shy"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = -30, PALE_DAMAGE = 0, FIRE = 15)
...
/obj/item/clothing/suit/armor/ego_gear/teth/trick
	...
	icon_state = "trick"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = -20, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = 5)

/obj/item/clothing/suit/armor/ego_gear/teth/sorority
	name = "sorority"
	desc = "Call upon your bretheren to fight."
	icon_state = "sorority"
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 30, BLACK_DAMAGE = 0, PALE_DAMAGE = 0, FIRE = -10)
...
/obj/item/clothing/suit/armor/ego_gear/teth/hearth //my sweet home
	...
	icon_state = "hearth"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = 10, BLACK_DAMAGE = 10, PALE_DAMAGE = -10, FIRE = 10) //20
...
/obj/item/clothing/suit/armor/ego_gear/teth/lantern
	...
	icon_state = "lantern"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = 20, BLACK_DAMAGE = -10, PALE_DAMAGE = 0, FIRE = 5) //20
...
/obj/item/clothing/suit/armor/ego_gear/teth/curfew
	...
	icon_state = "curfew"
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 0, PALE_DAMAGE = 20, FIRE = -20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/page
	...
	icon_state = "page"
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 10, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = -20) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/snapshot
	...
	icon_state = "snapshot"
	armor = list(RED_DAMAGE = -40, WHITE_DAMAGE = 40, BLACK_DAMAGE = 0, PALE_DAMAGE = 0, FIRE = -40)
...
/obj/item/clothing/suit/armor/ego_gear/teth/sloshing
	...
	icon_state = "sloshing"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -10, BLACK_DAMAGE = 0, PALE_DAMAGE = 0, FIRE = 15) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/fourleaf_clover
	...
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 20, BLACK_DAMAGE = 10, PALE_DAMAGE = 0, FIRE = -10) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/patriot
	name = "patriot"
	desc = "To protect your country, you must fight to the very end."
	icon_state = "patriot"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -20, BLACK_DAMAGE = 0, PALE_DAMAGE = 10, FIRE = 15) // 20
...
/obj/item/clothing/suit/armor/ego_gear/teth/zauberhorn
	...
	armor = list(RED_DAMAGE = -30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = -30) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/visions
	name = "visions of future past"
	desc = "It's looking right at you."
	icon_state = "visions"
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 40, BLACK_DAMAGE = -30, PALE_DAMAGE = 0, FIRE = -10) // 0
...
/obj/item/clothing/suit/armor/ego_gear/teth/faelantern
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 30, BLACK_DAMAGE = -30, PALE_DAMAGE = 0, FIRE = 10) // 20

/obj/item/clothing/suit/armor/ego_gear/teth/kikimora
	name = "kiki mora"
	desc = "A dress spun by unusual hands. Rough but resistant to stains."
	icon_state = "kikimora"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = -10, BLACK_DAMAGE = 30, PALE_DAMAGE = -10, FIRE = 5)
...
/obj/item/clothing/suit/armor/ego_gear/teth/denial
	...
	icon_state = "denial"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = -20, BLACK_DAMAGE = 0, PALE_DAMAGE = 20, FIRE = 10)
...
/obj/item/clothing/suit/armor/ego_gear/teth/clayman
	...
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = 10, BLACK_DAMAGE = -10, PALE_DAMAGE = 10, FIRE = 5)
