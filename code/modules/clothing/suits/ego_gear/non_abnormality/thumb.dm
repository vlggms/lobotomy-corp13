/obj/item/clothing/suit/armor/ego_gear/city/thumb
	...
	icon_state = "thumb"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 20, FIRE = 15)
...
/obj/item/clothing/suit/armor/ego_gear/city/thumb_capo
	...
	icon_state = "capo"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = 30, FIRE = 20)
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/city/thumb_sottocapo
	...
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 50, FIRE = 30)
	attribute_requirements = list(
