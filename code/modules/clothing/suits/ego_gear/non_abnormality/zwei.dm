/obj/item/clothing/suit/armor/ego_gear/city/zweijunior
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 0, BLACK_DAMAGE = 0, PALE_DAMAGE = 0, FIRE = 15)
...
/obj/item/clothing/suit/armor/ego_gear/city/zweiriot
	...
	icon_state = "zweiriot"
	slowdown = 0.7
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 20, FIRE = 35)
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 60,
							PRUDENCE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 60,
...
/obj/item/clothing/suit/armor/ego_gear/city/zweivet
	...
	icon_state = "zweivet"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = 20, FIRE = 25)
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/city/zweiwest
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = 10, FIRE = 25)
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 60,
							PRUDENCE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 60,
...
/obj/item/clothing/suit/armor/ego_gear/city/zweiwestvet
	...
	slowdown = 0.4
	neck = /obj/item/clothing/neck/ego_neck/zweiwest
	armor = list(RED_DAMAGE = 60, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 30, FIRE = 30)
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 80,
							PRUDENCE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 60,
...
/obj/item/clothing/suit/armor/ego_gear/city/zweiwestleader
	...
	slowdown = 0.4
	neck = /obj/item/clothing/neck/ego_neck/zweiwest
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 40, FIRE = 35)
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 100,
							PRUDENCE_ATTRIBUTE = 60,
							TEMPERANCE_ATTRIBUTE = 80,
