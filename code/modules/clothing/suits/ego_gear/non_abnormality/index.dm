/obj/item/clothing/suit/armor/ego_gear/city/index
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 30, FIRE = 10)
...
/obj/item/clothing/suit/armor/ego_gear/adjustable/index_proxy //Choose your Drip babey
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 30, BLACK_DAMAGE = 30, PALE_DAMAGE = 40, FIRE = 15)
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/city/index_mess
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 60, FIRE = 25)
	attribute_requirements = list(
