...
/obj/item/clothing/suit/armor/ego_gear/he/grinder
	...
	icon_state = "grinder"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = -10, BLACK_DAMAGE = 20, PALE_DAMAGE = 20, FIRE = 20) // 70
...
/obj/item/clothing/suit/armor/ego_gear/he/harvest
	...
	icon_state = "harvest"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 20, BLACK_DAMAGE = -20, PALE_DAMAGE = 20, FIRE = 25) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/fury
	...
	armor = list(RED_DAMAGE = 70, WHITE_DAMAGE = -20, BLACK_DAMAGE = -20, PALE_DAMAGE = -20, FIRE = 35) // 10
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/he/lutemis
	...
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 60, BLACK_DAMAGE = 20, PALE_DAMAGE = 20, FIRE = -20) // 80, Special armor.
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/paw
	...
	icon_state = "bear_paw"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 0, PALE_DAMAGE = 20, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/wings
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 50, BLACK_DAMAGE = -20, PALE_DAMAGE = 20, FIRE = 10) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/remorse
	...
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 50, BLACK_DAMAGE = 10, PALE_DAMAGE = 20, FIRE = -10) // 70
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/he/magicbullet
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 20, FIRE = 40) // 80
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/logging
	...
	icon_state = "logging"
	flags_inv = HIDESHOES
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = -20, BLACK_DAMAGE = 30, PALE_DAMAGE = 20, FIRE = 20) // 70
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/he/prank
	...
	icon_state = "prank"
	flags_inv = HIDESHOES
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -20, BLACK_DAMAGE = 40, PALE_DAMAGE = 20, FIRE = 15) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/harmony
	...
	icon_state = "harmony"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 30, BLACK_DAMAGE = 0, PALE_DAMAGE = 10, FIRE = 15)
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/frostsplinter
	...
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 30, BLACK_DAMAGE = 0, PALE_DAMAGE = 50, FIRE = -30)
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/sanguine
	...
	icon_state = "sanguine"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = -10, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = 25)
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/solemnlament
	...
	armor = list (RED_DAMAGE = -30, WHITE_DAMAGE = 50, BLACK_DAMAGE = 50, PALE_DAMAGE = 0, FIRE = -30) //70
	attribute_requirements = list(
		JUSTICE_ATTRIBUTE = 40
	)
...
/obj/item/clothing/suit/armor/ego_gear/he/courage
	...
	armor = list (RED_DAMAGE = 40, WHITE_DAMAGE = -20, BLACK_DAMAGE = 0, PALE_DAMAGE = 50, FIRE = 20) //70
	attribute_requirements = list(
								FORTITUDE_ATTRIBUTE = 40
								)
...
/obj/item/clothing/suit/armor/ego_gear/he/brick
	...
	icon_state = "brick"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 50, BLACK_DAMAGE = -20, PALE_DAMAGE = 10, FIRE = 15)
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/pleasure
	...
	icon_state = "pleasure"
	armor = list(RED_DAMAGE = -30, WHITE_DAMAGE = 40, BLACK_DAMAGE = 40, PALE_DAMAGE = 20, FIRE = -30) //70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40)
...
/obj/item/clothing/suit/armor/ego_gear/he/unrequited
	...
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 50, BLACK_DAMAGE = 30, PALE_DAMAGE = 10, FIRE = -20)
	attribute_requirements = list(
...
/obj/item/clothing/suit/armor/ego_gear/he/alley
	...
	icon_state = "alleyway"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = -10, BLACK_DAMAGE = 40, PALE_DAMAGE = 20, FIRE = 10)
...
/obj/item/clothing/suit/armor/ego_gear/he/gaze
	...
	icon_state = "gaze"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 30, BLACK_DAMAGE = 20, PALE_DAMAGE = 0, FIRE = 10)
...
/obj/item/clothing/suit/armor/ego_gear/he/transmission
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 0, FIRE = 15)
	attribute_requirements = list(PRUDENCE_ATTRIBUTE = 40)
...
/obj/item/clothing/suit/armor/ego_gear/he/metal
	...
	icon_state = "metal"
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 10, BLACK_DAMAGE = 10, PALE_DAMAGE = 0, FIRE = 25)
	attribute_requirements = list(FORTITUDE_ATTRIBUTE = 40)
...
/obj/item/clothing/suit/armor/ego_gear/he/homing_instinct
	...
	armor = list(RED_DAMAGE = -20, WHITE_DAMAGE = 30, BLACK_DAMAGE = 50, PALE_DAMAGE = 10, FIRE = -20)
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/maneater
	...
	icon_state = "maneater"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 20, BLACK_DAMAGE = 30, PALE_DAMAGE = -10, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/inheritance
	...
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 30, BLACK_DAMAGE = 10, PALE_DAMAGE = -10, FIRE = 20) // 70
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/song
	...
	icon_state = "song"
	armor = list(RED_DAMAGE = -30, WHITE_DAMAGE = 40, BLACK_DAMAGE = 30, PALE_DAMAGE = 30, FIRE = -30) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/legerdemain
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 40, BLACK_DAMAGE = 20, PALE_DAMAGE = -20, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/get_strong
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = -20, BLACK_DAMAGE = 10, PALE_DAMAGE = 30, FIRE = 25) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/impending_day
	...
	flags_inv = NONE
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = -20, BLACK_DAMAGE = 50, PALE_DAMAGE = 20, FIRE = 50) // 70
	attribute_requirements = list(
							TEMPERANCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/fluid_sac
	...
	armor = list(RED_DAMAGE = -10, WHITE_DAMAGE = 30, BLACK_DAMAGE = 50, PALE_DAMAGE = 0, FIRE = -10) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/jackrabbit
	...
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 0, BLACK_DAMAGE = 50, PALE_DAMAGE = 0, FIRE = 10) // 70
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/replica
	...
	icon_state = "replica"
	armor = list(RED_DAMAGE = 20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = 10) // 70
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/warp
	...
	icon_state = "warp"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 0, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = 20) // 70
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/grasp
	...
	icon_state = "grasp"
	flags_inv = NONE
	armor = list (RED_DAMAGE = -20, WHITE_DAMAGE = 20, BLACK_DAMAGE = 20, PALE_DAMAGE = 50, FIRE = -20) //70
	attribute_requirements = list(
								JUSTICE_ATTRIBUTE = 40
								)
...
/obj/item/clothing/suit/armor/ego_gear/he/marionette
	...
	armor = list (RED_DAMAGE = -20, WHITE_DAMAGE = 50, BLACK_DAMAGE = 30, PALE_DAMAGE = 10, FIRE = -30) //70
	attribute_requirements = list(
								PRUDENCE_ATTRIBUTE = 40
								)
...
/obj/item/clothing/suit/armor/ego_gear/he/aedd
	...
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 10, BLACK_DAMAGE = 30, PALE_DAMAGE = 0, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/split
	...
	icon_state = "split"
	flags_inv = NONE//it's just a coat
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 30, BLACK_DAMAGE = 20, PALE_DAMAGE = -10, FIRE = 15) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/coiling
	...
	icon_state = "coiling"
	armor = list(RED_DAMAGE = 10, WHITE_DAMAGE = -10, BLACK_DAMAGE = 50, PALE_DAMAGE = 20, FIRE = 10) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/voodoo
	...
	icon_state = "voodoo"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = 30, BLACK_DAMAGE = -10, PALE_DAMAGE = 20, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/uturn
	...
	icon_state = "uturn"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 10, BLACK_DAMAGE = 0, PALE_DAMAGE = 20, FIRE = 20) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/nixie
	...
	icon_state = "nixie"
	armor = list(RED_DAMAGE = 40, WHITE_DAMAGE = 20, BLACK_DAMAGE = -20, PALE_DAMAGE = 30, FIRE = 20) // 70
	attribute_requirements = list(
							JUSTICE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/ardor_star
	...
	armor = list(RED_DAMAGE = 50, WHITE_DAMAGE = 0, BLACK_DAMAGE = 10, PALE_DAMAGE = 10, FIRE = 60) // 70
	attribute_requirements = list(
							PRUDENCE_ATTRIBUTE = 40
							)
...
/obj/item/clothing/suit/armor/ego_gear/he/telepole
	...
	icon_state = "telepole"
	armor = list(RED_DAMAGE = 30, WHITE_DAMAGE = -10, BLACK_DAMAGE = 40, PALE_DAMAGE = 10, FIRE = 15) // 70
	attribute_requirements = list(
							FORTITUDE_ATTRIBUTE = 40
							)
