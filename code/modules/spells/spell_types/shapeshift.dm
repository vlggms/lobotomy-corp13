...
/obj/shapeshift_holder/Initialize(mapload,obj/effect/proc_holder/spell/targeted/shapeshift/_source, mob/living/caster)
	...
	if(source.convert_damage)
		...
		shape.deal_damage(damapply, source.convert_damage_type, flags = (DAMAGE_FORCED), wound_bonus = CANT_WOUND);
...
/obj/shapeshift_holder/proc/restore(death=FALSE)
	...
	if(death)
		...
		stored.deal_damage(damapply, source.convert_damage_type, flags = (DAMAGE_FORCED), wound_bonus=CANT_WOUND)
	if(source.convert_damage)
