...
/proc/get_all_jobs()
	return list("Clerk","Squire", "Templar Knight", "Senior Agent", "Veteran Agent", "Agent Lieutenant", "Templar Banner Knight", "Department Captain", "Department Head","High Priest", "Archivist", "Shopkeep", "Lord", "Main Office Representative",
