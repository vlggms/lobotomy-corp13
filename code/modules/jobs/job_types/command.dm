...
/datum/job/command
	...
	spawnmessage = "You are the Extraction Officer. Your job is to manage the EGO console, Extraction purchase console, and power generation system. Your main goal is to make sure the agents are well-equipped."
...
/datum/job/command/records
	...
	spawnmessage = "You are the Records Officer. Your job is to manage Records. You have filing cabinets in the back of your office filled with all sorts of information; make sure the agents know this information. \
