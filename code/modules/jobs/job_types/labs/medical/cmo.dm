/datum/job/cmo
	...
	access = list(ACCESS_MEDICAL, ACCESS_PHARMACY, ACCESS_COMMAND, ACCESS_ARMORY, ACCESS_SECURITY)
	minimal_access = list(ACCESS_MEDICAL, ACCESS_PHARMACY, ACCESS_COMMAND, ACCESS_ARMORY, ACCESS_SECURITY)
