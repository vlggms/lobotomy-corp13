...
//	var/uniform = pick(/obj/item/clothing/under/limbus/shirt, /obj/item/clothing/under/limbus/prison)
	...
	if(!LAZYLEN(GLOB.sinner_weapons))
		to_chat(M, span_userdanger("This gamemode does not support more than 13 players due to gamemode instability! If you are seeing this message, contact the development team"))
		H.dust()
