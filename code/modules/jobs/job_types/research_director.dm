/datum/job/rd
	...
	access = list(ACCESS_RD, ACCESS_COMMAND, ACCESS_RND, ACCESS_GENETICS, ACCESS_MORGUE,
	...
	minimal_access = list(ACCESS_RD, ACCESS_COMMAND, ACCESS_RND, ACCESS_GENETICS, ACCESS_MORGUE,
						ACCESS_TOXINS, ACCESS_TELEPORTER, ACCESS_SEC_DOORS, ACCESS_MECH_SCIENCE,
						ACCESS_RESEARCH, ACCESS_ROBOTICS, ACCESS_XENOBIOLOGY, ACCESS_AI_UPLOAD,
						ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_GATEWAY, ACCESS_MINERAL_STOREROOM,
						ACCESS_TECH_STORAGE, ACCESS_MINISAT, ACCESS_MAINT_TUNNELS, ACCESS_NETWORK,
