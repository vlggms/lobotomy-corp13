...
#define VILLAIN_PHASE_ALIBI 7
#define VILLAIN_PHASE_DISCUSSION 8
#define VILLAIN_PHASE_VOTING 9
#define VILLAIN_PHASE_RESULTS 10
#define VILLAIN_PHASE_VICTORY_LAP 11
