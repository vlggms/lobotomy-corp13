...
#define VILLAIN_PHASE_PROCESSING 5
#define VILLAIN_PHASE_INVESTIGATION 6
#define VILLAIN_PHASE_TRIAL_BRIEFING 7
#define VILLAIN_PHASE_ALIBI 8
#define VILLAIN_PHASE_DISCUSSION 9
#define VILLAIN_PHASE_VOTING 10
#define VILLAIN_PHASE_RESULTS 11
#define VILLAIN_PHASE_VICTORY_LAP 12
...
#define VILLAIN_ACTION_PRIORITY_LOW 6
