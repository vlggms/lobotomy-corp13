...
/obj/mech_melee_attack(obj/vehicle/sealed/mecha/mecha_attacker)
	...
	return take_damage(mecha_attacker.force * 3, mech_damtype, play_soundeffect, get_dir(src, mecha_attacker)) // multiplied by 3 so we can hit objs hard but not be overpowered against mobs.
