...
/mob/living/bullet_act(obj/projectile/P, def_zone, piercing_hit = FALSE)
	...
	if(!P.nodamage && on_hit_state != BULLET_ACT_BLOCK)
		apply_damage(P.damage * P.justice_multiplier, P.damage_type, def_zone, armor, wound_bonus=P.wound_bonus, bare_wound_bonus=P.bare_wound_bonus, sharpness = P.sharpness, white_healable = P.white_healing)
