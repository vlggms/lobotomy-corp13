...
/mob/living/simple_animal/hostile/abnormality/white_night
	...
	observation_success_message = "Thy question is worth no answer, for it's answer is clear" //TODO: multiple messages, the answer should be irrelevant, code should check for wing gift.
