 ...
 */
/mob/living/simple_animal/hostile/abnormality/nobody_is/proc/CopyHumanAppearance(mob/the_target)
	...
	if(iscarbon(the_target))
		...
		the_target?.client?.prefs?.copy_to(copycat, icon_updates=TRUE, roundstart_checks=FALSE, character_setup=TRUE)
	SLEEP_CHECK_DEATH(1)
