...
/mob/living/simple_animal/hostile/abnormality/pink_shoes
	...
	var/mob/living/simple_animal/hostile/abnominion/grown_strong/special_possessee
...
/mob/living/simple_animal/hostile/abnormality/pink_shoes/proc/Convert(mob/living/target)
	...
	var/mob/living/simple_animal/hostile/abnominion/pink_zombie/Z = new(get_turf(target), target)
	Z.name = target.name
...
/mob/living/simple_animal/hostile/abnominion/pink_zombie
...
/mob/living/simple_animal/hostile/abnominion/pink_zombie/Initialize(loc, mob/living/H)
	..()
	if(!IsCombatMap())
...
/mob/living/simple_animal/hostile/abnominion/pink_zombie/Life()
	. = ..()
	if(!.) // Dead
		return FALSE
	if(status_flags & GODMODE)
...
/mob/living/simple_animal/hostile/abnominion/pink_zombie/death(gibbed)
