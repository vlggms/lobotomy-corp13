...
/mob/living/simple_animal/hostile/abnormality/beanstalk
	...
	observation_prompt = "You remember an employee was obsessed with this abnormality. <br>\"If you reach the top, you'll find what you've been looking for!\", He'd tell every employee. <br>\
