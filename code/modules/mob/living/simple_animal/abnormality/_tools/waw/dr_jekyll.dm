...
/datum/status_effect/display/hyde/tick()
	...
	var/new_boost = (status_holder.maxSanity - status_holder.sanityhealth) * 2
...
/datum/action/cooldown/dr_jekyll/Trigger()
	...
	if(!effect)
		to_chat(H, span_userdanger("You allow hyde to guide your actions."))
...
// We attach some stat boosts to the panic. For science.
