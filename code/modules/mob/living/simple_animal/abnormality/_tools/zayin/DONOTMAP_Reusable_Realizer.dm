/obj/structure/toolabnormality/reusablerealizer
	name = "overclocked realization engine"
	desc = "An artifact used to find true potential within certains items. This one has been overclocked and can be used multiple times."
	icon = 'ModularTegustation/Teguicons/32x48.dmi'
	icon_state = "bough_pedestal"
/// the realized users part has been removed, hoping that's enough to make it work
...
//I don't even know what was wrong with these lines

//deleted the YinYangCheck because it was fucking something I dont understand up
