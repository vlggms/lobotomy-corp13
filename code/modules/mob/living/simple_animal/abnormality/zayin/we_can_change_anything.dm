#define STATUS_EFFECT_BUNNY /datum/status_effect/we_can_change_anything
/mob/living/simple_animal/hostile/abnormality/we_can_change_anything
	...
	work_damage_amount = 10 //you really cant fail these works, so its kinda pointless to have this
...
/mob/living/simple_animal/hostile/abnormality/wecanchange/work_chance(mob/living/carbon/human/user, chance)
	. = ..()
	if (istype(user.ego_gift_list[BROOCH], /datum/ego_gifts/change))
		return chance + 5
...
/datum/status_effect/we_can_change_anything
	...
	duration = 3000		//Lasts 10 minutes, guaranteed.
