...
/mob/living/simple_animal/hostile/abnormality/nosferatu/BreachEffect(mob/living/carbon/human/user, breach_type)
	...
	var/list/units_to_add = list(
		/mob/living/simple_animal/hostile/abnominion/nosferatu_mob = 8
		)
...
/mob/living/simple_animal/hostile/abnormality/nosferatu/proc/BatSpawn(atom/the_target)
	...
	var/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/B = new(get_turf(target_atom))
	spawned_bats+=B
...
/mob/living/simple_animal/hostile/abnormality/nosferatu/attack_animal(mob/living/simple_animal/M)
	if(!istype(M, /mob/living/simple_animal/hostile/abnominion/nosferatu_mob))
		return ..()
	var/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/blood_transfer_target = M
...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob
...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/proc/AdjustThirst(blood_amount)
	var/datum/component/bloodfeast/bloodfeast = GetComponent(/datum/component/bloodfeast)
	bloodfeast.AdjustBlood(blood_amount)

/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/AttackingTarget(atom/attacked_target) // They gain blood on hit
	. = ..()
...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/OpenFire(atom/A)
...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/PickTarget(list/Targets)
...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/CanAttack(atom/the_target)
	if(istype(the_target, /mob/living/simple_animal/hostile/abnormality/nosferatu))
		return TRUE
	return ..()

/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/death(gibbed)
	var/datum/component/bloodfeast/bloodfeast = GetComponent(/datum/component/bloodfeast)
