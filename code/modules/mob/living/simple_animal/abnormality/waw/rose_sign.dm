...
/mob/living/simple_animal/hostile/abnormality/rose_sign
	...
	var/rose_type = /mob/living/simple_animal/hostile/aminion/rose_summoned
	var/rose_max = 4
	var/rose_cooldown
...
/mob/living/simple_animal/hostile/abnormality/rose_sign/BreachEffect(mob/living/carbon/human/user, breach_type)
	...
	if(breach_type != BREACH_MINING)//TODO: create attacking roses for this breach type
		...
		rose_type = /mob/living/simple_animal/hostile/aminion/rose_summoned/combat
...
/mob/living/simple_animal/hostile/abnormality/rose_sign/proc/SpawnBreachRose(mob/living/carbon/human/target, turf/T)
	if(rose_type == /mob/living/simple_animal/hostile/aminion/rose_summoned/combat)//during a mining breach, these are spawned around players
		T = get_ranged_target_turf(get_turf(target), pick(GLOB.alldirs), 1)
	if(locate(/mob/living/simple_animal/hostile/aminion/rose_summoned) in get_turf(T))//Needs to be tested in a multiplayer environment
	...
	var/damtype
	var/mob/living/simple_animal/hostile/aminion/rose_summoned/R
...
/mob/living/simple_animal/hostile/aminion/rose_summoned
...
/mob/living/simple_animal/hostile/aminion/rose_summoned/proc/PickColor(picked_color)
...
/mob/living/simple_animal/hostile/aminion/rose_summoned/Move()
	return FALSE

/mob/living/simple_animal/hostile/aminion/rose_summoned/CanAttack(atom/the_target)
	return FALSE

/mob/living/simple_animal/hostile/aminion/rose_summoned/Destroy()
...
/mob/living/simple_animal/hostile/aminion/rose_summoned/combat//mining breach variant
	maxHealth = 1000
	health = 1000
	ranged = TRUE
...
/mob/living/simple_animal/hostile/aminion/rose_summoned/combat/CanAttack(atom/the_target)
	if(prob(30))
		return OpenFire()

/mob/living/simple_animal/hostile/aminion/rose_summoned/combat/OpenFire()
	if(!can_act)
		return
	rootBarrage(target)//Ebony queen-style basic attack

/mob/living/simple_animal/hostile/aminion/rose_summoned/combat/PickColor(picked_color)
	..()
	switch(picked_color)
		if(RED_DAMAGE)
...
/mob/living/simple_animal/hostile/aminion/rose_summoned/combat/proc/rootBarrage(target, picked_color)//Ebony queen's basic attack, fired at a low rate.
	can_act = FALSE
	playsound(get_turf(target), 'sound/creatures/venus_trap_hurt.ogg', 75, 0, 5)
	SLEEP_CHECK_DEATH(3)
	var/turf/target_turf = get_turf(target)
...
/datum/status_effect/stacking/crownthorns
	...
	var/mob/living/simple_animal/hostile/aminion/rose_summoned/status_applicant
	var/mob/living/simple_animal/hostile/abnormality/rose_sign/master
