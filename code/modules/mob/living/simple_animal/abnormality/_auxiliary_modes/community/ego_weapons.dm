...
/obj/item/ego_weapon/mini/limos
	...
	special = "This weapon has a combo system. To turn off this combo system, use in hand. \
			This weapon has a fast attack speed, and is capable of closing short gaps when attacking."
	icon_state = "limos"
	icon = 'code/modules/mob/living/simple_animal/abnormality/_auxiliary_modes/community/!icons/ego_weapons.dmi'
	force = 35
	damtype = RED_DAMAGE
...
/obj/item/ego_weapon/wield/ochre
	...
	special = "This weapon can be held in both hands to fire a projectile that scales with justice."
	icon_state = "ochre"
	icon = 'code/modules/mob/living/simple_animal/abnormality/_auxiliary_modes/community/!icons/ego_weapons.dmi'

/obj/item/ego_weapon/lance/miasma
	name = "miasma skin"
	desc = "I'm melting! Melting! Oh what a world, what a world!"
	special = "This lance leaves behind a damaging acid trail when charging."
	icon_state = "miasma"
	icon = 'code/modules/mob/living/simple_animal/abnormality/_auxiliary_modes/community/!icons/ego_weapons.dmi'
