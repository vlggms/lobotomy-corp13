...
/mob/living/simple_animal/adjustFireLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., FIRE, 100 * damage_coeff.burn * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustOxyLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., OXY, 100 * damage_coeff.oxy * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustToxLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., TOX, 100 * damage_coeff.tox * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustCloneLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., CLONE, 100 * damage_coeff.clone * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustStaminaLoss(amount, updating_health = FALSE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., STAMINA, 100 * damage_coeff.stamina)
	update_stamina()
...
/mob/living/simple_animal/adjustRedLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., RED_DAMAGE, 100 * damage_coeff.red * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustWhiteLoss(amount, updating_health = TRUE, forced = FALSE, white_healable = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., WHITE_DAMAGE, 100 * damage_coeff.white * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustBlackLoss(amount, updating_health = TRUE, forced = FALSE, white_healable = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., BLACK_DAMAGE, 100 * damage_coeff.black * CONFIG_GET(number/damage_multiplier))
...
/mob/living/simple_animal/adjustPaleLoss(amount, updating_health = TRUE, forced = FALSE)
	if(forced)
		...
		ez_dmg_numbers_text(src.loc, ., PALE_DAMAGE, 100 * damage_coeff.pale * CONFIG_GET(number/damage_multiplier))
