...
/mob/living/simple_animal/hostile/guardian/protector
	...
	damage_coeff = list(BRUTE = 0.4, FIRE = 0.4, TOX = 0.4, CLONE = 0.4, STAMINA = 0, OXY = 0.4)
...
/mob/living/simple_animal/hostile/guardian/protector/ToggleMode()
	...
	if(toggle)
		...
		speed = initial(speed)
		ChangeResistances(list(BRUTE = 0.4, FIRE = 0.4, TOX = 0.4, CLONE = 0.4, STAMINA = 0, OXY = 0.4))
		...
		speed = 1
		ChangeResistances(list(BRUTE = 0.05, FIRE = 0.05, TOX = 0.05, CLONE = 0.05, STAMINA = 0, OXY = 0.05)) //damage? what's damage?
