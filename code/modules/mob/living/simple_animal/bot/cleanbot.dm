...
/mob/living/simple_animal/bot/cleanbot
	...
	var/static/list/officers = list("Captain", "Head of Personnel", "Head of Security","Manager","Extraction Officer","Records Officer", "Control Team Captain")
	...
	var/static/list/LC_highStaff = list("Arbiter"="Arbiter","Manager"="Manager","Sephirah"="Sephirah","Training Officer"="TO","Disciplinary Officer"="DO","Extraction Officer" = "EO.","Records Officer" = "RO.", "Control Team Captain"="Agent Cpt.", "Department Head"="Dep. Head")
