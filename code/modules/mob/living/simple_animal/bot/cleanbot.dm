...
/mob/living/simple_animal/bot/cleanbot
	...
	var/static/list/LC_highStaff = list("Arbiter"="Arbiter","Manager"="Manager","Sephirah"="Sephirah","Extraction Officer" = "EO.","Records Officer" = "RO.", "Control Team Captain"="Agent Cpt.", "Department Head"="Dep. Head")
