/mob/living/simple_animal/hostile/rce/sapper
	name = "X-Corp Sapper"
...
/mob/living/simple_animal/hostile/rce/sapper/AttackingTarget(atom/attacked_target)
	. = ..()
...
/mob/living/simple_animal/hostile/rce/sapper/toggle_ai(togglestatus)
	if(togglestatus != AI_ON && togglestatus != AI_IDLE)
		..()

/mob/living/simple_animal/hostile/rce/sapper/say(message, bubble_type, list/spans = list(), sanitize = TRUE, datum/language/language = null, ignore_spam = FALSE, forced = null)
	..()
	if(stat)
		return
...
/mob/living/simple_animal/hostile/rce/GiveTarget(atom/new_target)
	. = ..(new_target)

/mob/living/simple_animal/hostile/rce/sapper/Life()
	..()
	if(stat)
		return
	if(prob(10))
