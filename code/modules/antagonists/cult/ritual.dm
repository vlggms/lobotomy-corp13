...
/obj/item/melee/cultblade/dagger/proc/scribe_rune_attempt(mob/living/user)
	...
	if(user.blood_volume)
		user.deal_damage(initial(rune_to_scribe.scribe_damage), BRUTE, def_zone = pick(BODY_ZONE_L_ARM, BODY_ZONE_R_ARM), wound_bonus = CANT_WOUND) // *cuts arm* *bone explodes* ever have one of those days?
