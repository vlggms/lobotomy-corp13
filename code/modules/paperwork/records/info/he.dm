...
/obj/item/paper/fluff/he/info/silent_girl
    ...
    - Agents under the effect of 'Guilt' have reported significantly decreased work success rate.
    ...
    - When Silent Girl's Qliphoth counter hit 0, all Agents under the effects of 'Guilt' proceeded to panic and attempt to breach the nearest Abnormality. After successfully breaching an Abnormality, the Agent was then found dead from self-inflicted injuries.<br><br>
    <h4>Instinct:</h4> Very Low<br>
