...
/obj/item/paper/fluff/info/teth/cinderella
	...
	abno_code = "F-05-21"
	abno_info = list(
		"When a work process began, the work success rate increased based on how good the abnormality's physical condition.",
		"When Repression work was performed, the abnormality's condition worsened and it eventually began to rot.",
		"When Insight Work was performed, the Qliphoth Counter decreased.",
		"When the Qliphoth Counter reached zero, the physical condition of the abnormality improved significantly.",
		"After its condition improves beyond a certain point, the abnormality will travel through the facility on a horizontal path, dealing massive WHITE damage to everything it impacts.")
