...
/obj/item/paper/fluff/info/aleph/titania
	...
	- Titania continually summoned hostile fairies until her demise. 	<br>
	<br>
	<h4>Instinct:</h4> Common<br>
	<h4>Insight:</h4> Common<br>
	<h4>Attachment:</h4> Low<br>
...
/obj/item/paper/fluff/info/aleph/space_lady
	...
	- When the employee who worked on Lady out of Space was level 4, the Qliphoth Counter lowered. It lowered again if the employee was level 3.	<br>
	- When the employee who worked on Lady out of Space was level 1 or 2, they were consumed before work started and lowered the counter.<br>
