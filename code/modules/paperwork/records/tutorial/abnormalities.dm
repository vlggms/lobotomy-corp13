...
/obj/item/paper/fluff/info/tutorial/bill
	...
	- When the Qliphoth Counter reached 0, Bill escaped its Containment Unit.	<br>
	- Bill returned to its Containment Unit after a minute.	<br>
...
/obj/item/paper/fluff/info/tutorial/cube
	...
	Work Damage : Low	<br>
	- When Repression work was completed, the Qliphoth Counter lowered.	<br>
	- When the Qliphoth Counter reached 0, THE CUBE escaped its Containment Unit.	<br>
	- THE CUBE returned to its Containment Unit after a minute.	<br>
...
/obj/item/paper/fluff/info/tutorial/shadow
	...
	Work Damage : Low	<br>
	- Performing Attachment work lowered the Qliphoth Counter.	<br>
	- When the work result was Bad, the Qliphoth Counter lowered.	<br>
	- When the Qliphoth Counter reached 0, Shadow Man escaped its Containment Unit.	<br>
	- Shadow Man returned to Containment Unit after a minute.	<br>
	<h4>Instinct:</h4> High<br>
...
/obj/item/paper/fluff/info/tutorial/fairy
	...
	- When the Qliphoth Counter reached 0, Fairy Swarm escaped its Containment Unit.	<br>
	- The Fairy Swarm returned to its Containment Unit after a minute.	<br>
