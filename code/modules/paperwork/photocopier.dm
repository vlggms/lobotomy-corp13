	...
	switch(action)
		...
		if("print_blank")
			...
			if (toner_cartridge.charges - PAPER_TONER_USE < 0)
				...
				return FALSE
			do_copy_loop(CALLBACK(src, PROF_REF(make_blank_print)), usr)
...
/obj/item/toner
	...
	desc = "A small, lightweight cartridge of L-Corporation ValueBrand toner. Fits photocopiers and autopainters alike."
...
/obj/item/toner/large
	...
	desc = "A hefty cartridge of L-Corporation ValueBrand toner. Fits photocopiers and autopainters alike."
