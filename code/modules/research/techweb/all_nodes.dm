...
/datum/techweb_node/cyborg_upg_med
	...
	design_ids = list("borg_upgrade_defibrillator", "borg_upgrade_piercinghypospray", "borg_upgrade_expandedsynthesiser", "borg_upgrade_pinpointer", "borg_upgrade_surgicalprocessor", "borg_upgrade_beakerapp", "borg_upgrade_medbeam") // TEGU
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 2000)
...
/datum/techweb_node/sec_basic
	...
	design_ids = list("seclite", "pepperspray", "bola_energy", "zipties", "evidencebag", "sec_radio", "protolathe_handcuffs", "stun_baton", "sec_belt", "security_helmet", "security_armor", "security_uniform", "security_boots", "security_headset", "forensic_data_disk") // TEGUSTATION Improved Sec Starter Gear by Surrealistik MAR 2020
	prereq_ids = list("base")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 1000)
