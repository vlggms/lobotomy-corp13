...
/datum/crafting_recipe/zwei_junior
	...
	reqs = list(
		/obj/item/stack/sheet/silk/green_simple = 1,
...
/datum/crafting_recipe/zwei_vet
	...
	reqs = list(
		/obj/item/stack/sheet/silk/shrimple_advanced = 2,
...
/datum/crafting_recipe/zwei_dir
	...
	reqs = list(
		/obj/item/stack/sheet/silk/shrimple_elegant = 2,
		/obj/item/stack/sheet/silk/amber_elegant = 1,
