...
/datum/abnormality/proc/AddWorkStats(mob/living/carbon/human/user, pe = 0, attribute_type = "N/A", attribute_given = 0, activity_check = 0 MINUTES)
	...
	if(activity_check)
		SSlobotomy_corp.work_stats[user_name]["activity_check"] = world.time
