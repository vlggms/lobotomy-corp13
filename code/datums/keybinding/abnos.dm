/datum/keybinding/abno
	category = CATEGORY_ABNOS

/datum/keybinding/abno/blue_shepherd_dodge
...
/datum/keybinding/abno/blue_shepherd_dodge/down(client/user)
	. = ..()
	if(.)
		return
...
/datum/keybinding/abno/blue_shepherd_counter
...
/datum/keybinding/abno/blue_shepherd_counter/down(client/user)
	. = ..()
	if(.)
		return
	if (!istype(user.mob, /mob/living/simple_animal/hostile/abnormality/blue_shepherd))
...
/datum/keybinding/abno/der_freischutz_portal_view
	hotkey_keys = list("Space") // PAGEUP
...
/datum/keybinding/abno/der_freischutz_portal_view/down(client/user)
	. = ..()
	if(.)
		return
...
/datum/keybinding/abno/der_freischutz_portal_remove/down(client/user)
	. = ..()
	if(.)
		return
	if (!istype(user.mob, /mob/living/simple_animal/hostile/abnormality/der_freischutz))
...
/datum/keybinding/abno/fragment_song
...
/datum/keybinding/abno/fragment_song/down(client/user)
	. = ..()
	if(.)
		return
