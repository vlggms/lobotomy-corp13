...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_BRUTEPALE" = TRAIT_BRUTEPALE,
		"TRAIT_BRUTESANITY" = TRAIT_BRUTESANITY,
		...
		"TRAIT_WORKFEAR_IMMUNE" = TRAIT_WORKFEAR_IMMUNE,
		...
		"TRAIT_STRONG_MELEE" = TRAIT_STRONG_MELEE,
		"TRAIT_BETTER_GUNS" = TRAIT_BETTER_GUNS,
		"TRAIT_BONUS_EXP" = TRAIT_BONUS_EXP,
		"TRAIT_NOEGOWEAPONS" = TRAIT_NOEGOWEAPONS,
		...
		"TRAIT_ALCOHOL_TOLERANCE" = TRAIT_ALCOHOL_TOLERANCE, // start of quirk stuff, mostly
		...
		// Start of special quirk stuff
		"TRAIT_MINOR_RED" = TRAIT_MINOR_RED,
		"TRAIT_MAJOR_RED" = TRAIT_MAJOR_RED,
		"TRAIT_FATAL_RED" = TRAIT_FATAL_RED,
		"TRAIT_MINOR_WHITE" = TRAIT_MINOR_WHITE,
		"TRAIT_MAJOR_WHITE" = TRAIT_MAJOR_WHITE,
		"TRAIT_FATAL_WHITE" = TRAIT_FATAL_WHITE,
		"TRAIT_MINOR_BLACK" = TRAIT_MINOR_BLACK,
		"TRAIT_MAJOR_BLACK" = TRAIT_MAJOR_BLACK,
		"TRAIT_FATAL_BLACK" = TRAIT_FATAL_BLACK,
		"TRAIT_MINOR_PALE" = TRAIT_MINOR_PALE,
		"TRAIT_MAJOR_PALE" = TRAIT_MAJOR_PALE,
		"TRAIT_FATAL_PALE" = TRAIT_FATAL_PALE,
		"TRAIT_RESISTANT" = TRAIT_RESISTANT,
