...
/obj/structure/table/proc/tablepush(mob/living/user, mob/living/pushed_mob)
	...
	pushed_mob.deal_damage(10, BRUTE, source = user, attack_type = (ATTACK_TYPE_OTHER))
	pushed_mob.deal_damage(40, STAMINA, source = user, attack_type = (ATTACK_TYPE_OTHER))
...
/obj/structure/table/proc/tablelimbsmash(mob/living/user, mob/living/pushed_mob)
	...
	pushed_mob.deal_damage(60, STAMINA, source = user, attack_type = (ATTACK_TYPE_OTHER))
	take_damage(50)
	if(user.mind?.martial_art.smashes_tables && user.mind?.martial_art.can_use(user))
		deconstruct(FALSE)
