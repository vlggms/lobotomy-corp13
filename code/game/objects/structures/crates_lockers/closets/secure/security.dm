...
/obj/structure/closet/secure_closet/warden/PopulateContents()
	..()
	new /obj/item/clothing/suit/armor/vest/zwei_jacket(src)
	new /obj/item/clothing/head/zwei(src)
	new /obj/item/clothing/head/zwei/drill(src)
	new /obj/item/clothing/head/beret/sec/navywarden(src)
	new /obj/item/clothing/suit/armor/vest/zwei_jacket/alt(src)
