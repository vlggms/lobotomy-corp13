...
/obj/structure/closet/jcloset/PopulateContents()
	...
	if(prob(20))
		new /obj/item/book/granter/language_book/draconic(src) // Tegustation
...
/obj/structure/closet/wardrobe/chaplain_black/PopulateContents()
	...
	new /obj/item/storage/fancy/candle_box(src)
	if(prob(10))
		new /obj/item/book/granter/language_book/narsian(src) // Tegustation
	return
...
/obj/structure/closet/wardrobe/curator/PopulateContents()
	...
	if(prob(50))
		new /obj/item/book/granter/language_book/common(src) // Tegustation
