...
/mob/living/carbon/human/proc/sec_hud_set_ID()
	...
	holder.icon =  'icons/mob/hud.dmi'  					// Tegustation Deputy edit: Reset to default icon, in case you swapped to a TEGU .dmi but we need to restore it.  **THIS IS TEMPORARY**
	if(wear_id?.GetID())
		var/obj/item/card/id/our_id = wear_id.GetID()
		holder.icon_state = "hud[ckey(wear_id.GetJobName())]"
		holder.icon = our_id.return_icon_hud()   	// Tegustation Deputy edit: This asks the ID to ask its associated Job what icon to use.
