...
/obj/machinery/sleeper
	...
	var/list/possible_chems = list(
		list(/datum/reagent/medicine/epinephrine, /datum/reagent/medicine/c2/probital, /datum/reagent/medicine/enkephalin, /datum/reagent/medicine/c2/aiuri, /datum/reagent/medicine/pen_acid),
		list(),
		list(),
		list()
	)
