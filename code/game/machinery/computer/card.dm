...
//COL LC13 Card Console
/obj/machinery/computer/card/hana
	name = "ID manipulation console"
	desc = "You can use this to change ID's if you have the authority."
	icon_screen = "idminor"
	circuit = null
	target_dept = 6
	blacklisted = list(
...
// Ill admit i did a sloppy job making this console -IP
/obj/machinery/computer/card/hana/ReturnUI()
	var/list/dat = list()
	switch(mode)
		if(1)
			// accessing crew manifest
