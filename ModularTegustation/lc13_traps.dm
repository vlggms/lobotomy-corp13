...
/obj/machinery/door/sigsystem/Initialize()
	. = ..()
...
/obj/machinery/door/sigsystem/Bumped(atom/movable/AM)
	return !density && ..()

/obj/machinery/door/sigsystem/emp_act(severity)
	return

/obj/machinery/door/sigsystem/ex_act(severity, target)
	return

/obj/machinery/door/sigsystem/proc/pulse(code)
	if(code == lock_signaller_code)
		if(density)
			open()
		else
			close()
