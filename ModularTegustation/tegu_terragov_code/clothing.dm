...
/obj/item/clothing/accessory/armband/citygov/un
	...
	desc = "A light-blue armband that was worn by the old world government. They say mankind once lived beyond the city limits."
	icon_state = "tgunband"

/obj/item/clothing/accessory/armband/russian
	name = "russian armband"
	desc = "An armband that is worn by nostalgic citizens of the district, who ramble about a long dead civilization."
	icon_state = "rusband"
