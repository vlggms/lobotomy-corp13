...
/datum/adventure_event/todd_damn_it
	...
	"You jolt awake, being taken down the bumpy streets on a cart.<br>\
	\"Hey, you.\" a defiant man with bound hands addresses you \"You're finally awake.\"<br>\
	The cart is pulled into a small village, where men, soldiers, glare at you.<br>\
	You aren't quite sure where you are, or who these people are. You only know one thing.<br>\
	<br>\
	You're being lead to your death.",

	"You refuse to just sit and wait for your death, at the first opportunity you get you headbutt a guard and bolt away from the cart!<br>\
	Just as you're about to round the next corner you feel a sharp pain through back. You cough up blood before collapsing to the ground.<br>\
	<br>\
	You come to curled up in a ball in an alley. What was that about?",

	"If you're going to face your death, it'll be with dignity.<br>\
	You're brought to the headsman's block and forced to kneel by a hard faced woman.<br>\
	A wave of calm overcomes you as you close your eyes and accept fate.<br>\
	The last thing you feel is cold steel making contact with your neck.<br>\
	<br>\
	You come to curled up in a ball in an alley. What was that about?",
	)
