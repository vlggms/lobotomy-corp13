/datum/adventure_event/ncorp_events/dance
	...
	You submit your request, and due to your high loyalty, they agree to give you the night off. <br>\
	...
	'You know how to waltz?' She asks, face in concentration as she's listening to the music <br>\
	...
	During his speech, your new partner turns to you.  <br>\
	'It's so hot in here.' She smiles, and begins to remove her gloves and roll up her sleeves.<br>\
	And you see it; her metalic arm shining in the light of the dining hall.",
	...
	You shove her to the ground, and press your foot against her chest. Pulling with all your might, you rip her cheap prosthetic arm off and hear her ribs crack. <br>\
	...
	'We meet again some time.' Her voice is shaking. <br>\
...
/datum/adventure_event/ncorp_events/dance/EventChoiceFormat(obj/machinery/M, mob/living/carbon/human/H)
	switch(cords)
		...
		if(2)
			...
			AdjustStatNum(LUST_STAT,1)		//Tiny lust bonus for your troubles. She turns your face red so
		...
		if(4)
			...
			return
		if(5)
			AdjustStatNum(PRIDE_STAT,-10)	//You shouldn't have done that.
