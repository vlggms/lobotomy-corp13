...
/obj/structure/sigsystem/tower/keypad/RegisterAsTower()
	return

/obj/structure/sigsystem/tower/keypad/ReceivePing()
	return
...
/obj/structure/sigsystem/tower/button/RegisterAsTower()
	return

/obj/structure/sigsystem/tower/button/ReceivePing()
	return
