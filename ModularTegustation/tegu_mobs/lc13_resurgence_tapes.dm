...
/obj/item/tape/resurgence/podcast_seven
	...
	storedinfo = list(
		...
		"Lights are heard flickering on as a simple jingle plays in the background...",
		...
		"In the background, You can hear some object slowly winding up…",
		...
		"A robotic laughter is heard in the background as the winding from the object in the background stops.",
		...
		"Sounds of papers being flipped are heard.",
		...
		"An awfully long pause occurs as gasps could be heard in the background.",
		...
		"A quick sound of a gears winding back is heard.",
...
/obj/item/tape/resurgence/temple_of_motus
	...
	storedinfo = list(
		...
		"The flipping of pages are heard coming from the “Old Robotic Voice…”",
		...
		"Suddenly, All of the mechanical footsteps stop for a moment.",
		...
		"4 small knocks are heard coming from the “Old Robotic Voice”, as if they were hitting some stone floor…",
		"The ground soon begins to rumble… as crumbling rocks and shifting gears can be heard rising from the ground, before eventually ending in a thud.",
...
/obj/item/tape/resurgence/new_library
	...
	storedinfo = list(
	"The sounds of shifting machinery and distant conversations could be heard around the room…",
	...
	"A pair of mechanical footsteps are heard as a heavy door slides open…",
	...
	"The “Old Robotic Voice” slows down for a moment…",
	...
	span_game_say(span_name("Rusty Robotic Voice") + span_message(" says,") + " &quot;Oh, Sorry Sir. You need to understand what a change this is, Back at the town I got access to only like… 5 books a month?&quot;"),
