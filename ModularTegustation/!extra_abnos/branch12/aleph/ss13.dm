...
/mob/living/simple_animal/hostile/abnormality/branch12/ss13/Life()
	...
	if(integrity > 0 || fuel> 0 )
		...
		for(var/mob/living/carbon/human/H in GLOB.mob_list)
			to_chat(H, span_warning("ERROR. ERROR. HULL INTEGRITY 0. STATION IS DEORBITING. SEEK SHELTER IMMEDIATELY."))
...
/mob/living/simple_animal/hostile/abnormality/branch12/ss13/PostWorkEffect(mob/living/carbon/human/user, work_type, pe, work_time, canceled)
	...
	switch(work_type)
		if(ABNORMALITY_WORK_INSTINCT)
			orders = "repair"
			say("Engineers and atmospheric techniciancs have been ordered to repair the station. Supplies will be consumed more quickly.")
...
/mob/living/simple_animal/hostile/abnormality/branch12/ss13/funpet()
