...
/obj/machinery/computer/extraction_cargo/discipline
	...
	order_list = list(
		...
		new /datum/data/extraction_cargo("L-Corp Baton Template ",			/obj/item/ego_weapon/city/lcorp/baton,								400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Machete Template " ,		/obj/item/ego_weapon/city/lcorp/machete,							400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Club Template ",			/obj/item/ego_weapon/city/lcorp/club,								400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Shield Template ",			/obj/item/ego_weapon/shield/lcorp_shield,							400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Pistol Template ",			/obj/item/ego_weapon/ranged/city/lcorp/pistol,						400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Machinepistol Template ",	/obj/item/ego_weapon/ranged/city/lcorp/automatic_pistol,			400, CAT_EQUIP) = 1,
		new /datum/data/extraction_cargo("L-Corp Armored Vest Template ",	/obj/item/clothing/suit/armor/ego_gear/city/lcorp_vest,				400, CAT_EQUIP) = 1,
		...
		new /datum/data/extraction_cargo("Tier 1 EGOSHARD (White) ",	/obj/item/egoshard/white,						50, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 1 EGOSHARD (Black) ",	/obj/item/egoshard/black,						50, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 2 EGOSHARD (Red) ",		/obj/item/egoshard/bad,							200, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 2 EGOSHARD (White) ",	/obj/item/egoshard/bad/white,					200, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 2 EGOSHARD (Black) ",	/obj/item/egoshard/bad/black,					200, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 3 EGOSHARD (Red) ",		/obj/item/egoshard/good,						500, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 3 EGOSHARD (White) ",	/obj/item/egoshard/good/white,					500, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 3 EGOSHARD (Black) ",	/obj/item/egoshard/good/black,					500, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 3 EGOSHARD (Pale) ",		/obj/item/egoshard/good/pale,					500, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 4 EGOSHARD (Red) ",		/obj/item/egoshard/great,						700, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 4 EGOSHARD (White) ",	/obj/item/egoshard/great/white,					700, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 4 EGOSHARD (Black) ",	/obj/item/egoshard/great/black,					700, CAT_RESOURCE) = 1,
		new /datum/data/extraction_cargo("Tier 4 EGOSHARD (Pale) ",		/obj/item/egoshard/great/pale,					700, CAT_RESOURCE) = 1,
