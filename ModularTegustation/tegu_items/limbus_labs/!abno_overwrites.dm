...
/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/Initialize()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("neutral", "nosferatu")

/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/Login()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("hostile", "nosferatu")

/mob/living/simple_animal/hostile/abnominion/nosferatu_mob/Logout()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("neutral", "nosferatu")
...
/mob/living/simple_animal/hostile/abnominion/soldier_bee/Initialize()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("neutral", "bee")

/mob/living/simple_animal/hostile/abnominion/soldier_bee/Login()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("hostile", "bee")

/mob/living/simple_animal/hostile/abnominion/soldier_bee/Logout()
	. = ..()
	if(SSmaptype.maptype == "limbus_labs")
		faction = list("neutral", "bee")
