...
/obj/item/portablepredict/proc/CalculateChance(datum/abnormality/A, mob/living/carbon/human/target, mob/living/carbon/human/user)
	...
	printed_paper.info = "<font color = #000000>\
	[A.get_work_chance(ABNORMALITY_WORK_INSTINCT, target)]<br> \
	[A.get_work_chance(ABNORMALITY_WORK_INSIGHT, target)]<br> \
	[A.get_work_chance(ABNORMALITY_WORK_ATTACHMENT, target)]<br> \
	[A.get_work_chance(ABNORMALITY_WORK_REPRESSION, target)]</font>"
