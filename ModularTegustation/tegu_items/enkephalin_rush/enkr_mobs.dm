...
/mob/living/simple_animal/hostile/humanoid/lcb_pallid
	name = "pallid thing"
	...
	butcher_results = list(/obj/item/food/meat/slab/pallid = 1)
	var/say_lines = list(
		"--.-.-",
		"-... .-",
		"-.-. ..-",
...
/mob/living/simple_animal/hostile/humanoid/lcb_pallid/Aggro()
	..()
	var/line = pick(say_lines)
	say(line)

/mob/living/simple_animal/hostile/humanoid/lcb_pallid/pistol
