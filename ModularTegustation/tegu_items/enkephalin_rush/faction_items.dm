...
/obj/item/stat_equalizer/mining/update_stats(mob/living/carbon/human/user)
	...
	if(GLOB.lobotomy_repairs) // dont divide by 0
		facility_full_percentage = 100 * (GLOB.lobotomy_damages * 100 + 1)
