/mob/living/simple_animal/hostile/abnormality/kqe
	...
	attack_sound = 'ModularTegustation/modular_abnormalities/he/KQE/sound/hitsound1.ogg'
	icon = 'ModularTegustation/modular_abnormalities/he/KQE/icons/96x64.dmi'
	icon_state = "kqe"
	icon_living = "kqe"
	icon_dead = "kqe_egg"
	del_on_death = FALSE
...
/mob/living/simple_animal/hostile/abnormality/kqe/proc/ClawGrab(target)
	...
	can_act = FALSE
	face_atom(target)
	playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/he/KQE/sound/load1.ogg', 75, 0, 3)
	icon_state = "kqe_prepare"
...
/obj/effect/kqe_claw/proc/GrabAttack()
	playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/he/KQE/sound/load2.ogg', 75, 0, 3)
