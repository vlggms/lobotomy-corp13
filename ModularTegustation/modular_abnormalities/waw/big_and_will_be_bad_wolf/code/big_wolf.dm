...
/mob/living/simple_animal/hostile/abnormality/big_wolf
	...
	attack_sound = 'ModularTegustation/modular_abnormalities/waw/big_and_will_be_bad_wolf/sound/Wolf_Scratch.ogg'
...
/mob/living/simple_animal/hostile/abnormality/big_wolf/proc/FleeNow()
	playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/waw/big_and_will_be_bad_wolf/sound/Wolf_FogChange.ogg', 75, 1)
...
/mob/living/simple_animal/hostile/abnormality/big_wolf/proc/SpewStomach()
	...
	playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/waw/big_and_will_be_bad_wolf/sound/Wolf_EatOut.ogg', 75, 1)
...
/mob/living/simple_animal/hostile/abnormality/big_wolf/proc/Howl()
	...
	if(do_after(src, 2 SECONDS, target = src))
		...
		playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/waw/big_and_will_be_bad_wolf/sound/Wolf_Howl.ogg', 30, 0, 4)
