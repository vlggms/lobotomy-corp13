...
/mob/living/simple_animal/hostile/abnormality/servant_wrath
	...
	rapid_melee = 2
	attack_sound = 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/small_smash1.ogg'
...
/mob/living/simple_animal/hostile/abnormality/servant_wrath/AttackingTarget(atom/attacked_target)
	...
	. = ..()
	attack_sound = pick('ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/small_smash1.ogg','ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/small_smash2.ogg')
...
/mob/living/simple_animal/hostile/abnormality/servant_wrath/BreachEffect(mob/living/carbon/human/user)
	...
	src.icon = 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/icons/96x64.dmi'
	icon_state = "wrath"
	pixel_x = -32
	base_pixel_x = -32
	...
	playsound(src, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/enrage.ogg', 100, FALSE, 40, falloff_distance = 20)
	toggle_ai(AI_ON)
	status_flags &= ~GODMODE
	...
	for(var/turf/dep in GLOB.department_centers)
		...
		playsound(dep, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/hermit_magic.ogg', 60, FALSE, 10)
		break
...
/mob/living/simple_animal/hostile/abnormality/servant_wrath/proc/Smash()
	...
	if(!friendly)
		...
		playsound(src, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/enrage.ogg', 75, FALSE, 20, falloff_distance = 10)
	...
	for(var/x = 1 to 3)
		...
		playsound(src, "ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/big_smash[x].ogg", 75, FALSE, 20, falloff_distance = 10) // heard from a distance
		for(var/i = 1 to 5)
			if(i < 4)
...
/mob/living/simple_animal/hostile/azure_hermit
	...
	attack_sound = 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/hermit_attack.ogg'
...
/mob/living/simple_animal/hostile/azure_hermit/AttackingTarget(atom/attacked_target)
	...
	if(istype(target, /mob/living/simple_animal/hostile/abnormality/servant_wrath))
		...
		if(SW.stunned)
			return
		if(SW.health > 400)
			playsound(SW, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/hermit_attack_hard.ogg', 75, FALSE, 15, falloff_distance = 5)
			...
			if(!can_act || (status_flags & GODMODE))
				return
			playsound(src, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/hermit_magic.ogg', 60, FALSE, 10)
			var/list/been_hit = list()
			for(var/i = 1 to 3)
			...
			playsound(SW, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/enrage.ogg', 100, FALSE, 40, falloff_distance = 20)
...
/mob/living/simple_animal/hostile/azure_hermit/proc/Befuddle()
	...
	for(var/turf/sT in show_area)
		new /obj/effect/temp_visual/cult/sparks(sT)
	SLEEP_CHECK_DEATH(1.5 SECONDS)
	playsound(src, 'ModularTegustation/modular_abnormalities/waw/servant_of_wrath/sound/hermit_magic.ogg', 75, FALSE, 10)
