...
/mob/living/simple_animal/hostile/abnormality/my_sweet_home
	...
	icon = 'ModularTegustation/modular_abnormalities/teth/my_sweet_home/icons/96x64.dmi'
...
/mob/living/simple_animal/hostile/abnormality/my_sweet_home/Moved()
	...
	if(!(status_flags & GODMODE)) // This thing's big, it should make some noise.
		playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/teth/my_sweet_home/sound/walk.ogg', 50, 1)
...
/mob/living/simple_animal/hostile/abnormality/my_sweet_home/proc/AoeAttack()
	...
	if(damage_dealt > 0)
		...
		playsound(get_turf(src), 'ModularTegustation/modular_abnormalities/teth/my_sweet_home/sound/smash.ogg', 50, 1)
