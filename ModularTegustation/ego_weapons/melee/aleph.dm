...
/obj/item/ego_weapon/justitia/attack(mob/living/M, mob/living/user)
	...
	switch(combo)
		...
		if(6)
			...
			user.HurtInTurf(T, list(), 24, PALE_DAMAGE)
		else
			hitsound = 'sound/weapons/ego/justitia1.ogg'
...
/obj/item/ego_weapon/smile
	...
	icon_state = "smile"
	force = 45 //Slightly less damage, has an ability
	attack_speed = 1.6
...
/obj/item/ego_weapon/blooming
	...
	icon_state = "rosered"
	force = 30 //Less damage, can swap damage type
	damtype = RED_DAMAGE
	swingstyle = WEAPONSWING_LARGESWEEP
...
/obj/item/ego_weapon/censored
	...
	force = 30	//there's a focus on the ranged attack here.
	damtype = BLACK_DAMAGE
...
/obj/item/ego_weapon/space
	...
	icon_state = "space"
	force = 24	//Half white, half black.
	damtype = WHITE_DAMAGE
	swingstyle = WEAPONSWING_LARGESWEEP
...
/obj/item/ego_weapon/seasons
	...
	var/list/season_list = list(
		"spring" = list(30, 1, 1, list("bashes", "bludgeons"), list("bash", "bludgeon"), 'sound/weapons/fixer/generic/gen1.ogg', "vernal equinox", WHITE_DAMAGE, WHITE_DAMAGE,
		"A gigantic, thorny bouquet of roses."),
		"summer" = list(45, 1.6, 1, list("tears", "slices", "mutilates"), list("tear", "slice","mutilate"), 'sound/abnormalities/seasons/summer_attack.ogg', "summer solstice", RED_DAMAGE, RED_DAMAGE,
		"Looks some sort of axe or bladed mace. An unbearable amount of heat comes off of it."),
		"fall" = list(38, 1.2, 1, list("crushes", "burns"), list("crush", "burn"), 'sound/abnormalities/seasons/fall_attack.ogg', "autumnal equinox",BLACK_DAMAGE ,BLACK_DAMAGE,
		"In nature, a light is often used as a simple but effective lure. This weapon follows the same premise."),
		"winter" = list(30, 1, 2, list("skewers", "jabs"), list("skewer", "jab"), 'sound/abnormalities/seasons/winter_attack.ogg', "winter solstice",PALE_DAMAGE ,PALE_DAMAGE,
...
/obj/item/ego_weapon/mockery
	...
	var/list/weapon_list = list(
		"whip" = list(12, 0.5, 3, list("lacerates", "disciplines"), list("lacerate", "discipline"), 'sound/weapons/whip.ogg'),
		"sword" = list(30, 1, 1, list("tears", "slices", "mutilates"), list("tear", "slice","mutilate"), 'sound/weapons/fixer/generic/blade4.ogg'),
		"hammer" = list(15, 1.4, 1, list("crushes"), list("crush"), 'sound/weapons/fixer/generic/baton2.ogg'),
		"bat" = list(45, 1.6, 1, list("bludgeons", "bashes"), list("bludgeon", "bash"), 'sound/weapons/fixer/generic/gen1.ogg')
		)
...
/obj/item/ego_weapon/oberon
	...
	var/list/weapon_list = list(
		...
		"sword" = list(35, 0.8, 1, list("tears", "slices", "mutilates"), list("tear", "slice","mutilate"), 'sound/weapons/fixer/generic/blade4.ogg', BLACK_DAMAGE, "This form can fire a projectile and does both RED DAMAGE and BLACK DAMAGE."),
		"hammer" = list(30, 1.4, 1, list("crushes"), list("crush"), 'sound/weapons/fixer/generic/baton2.ogg', BLACK_DAMAGE, "This form deals damage in an area and incease the RED and BLACK vulnerability by 0.2 to everything in that area."),
		"bat" = list(65, 1.6, 1, list("bludgeons", "bashes"), list("bludgeon", "bash"), 'sound/weapons/fixer/generic/gen1.ogg', RED_DAMAGE, "This form does RED DAMAGE and knocks back enemies."),
		"scythe" = list(40, 1.2, 1, list("slashes", "slices", "rips", "cuts"), list("slash", "slice", "rip", "cut"), 'sound/abnormalities/nothingthere/attack.ogg', RED_DAMAGE, "This form does RED DAMAGE and does 50% more damage when hitting targets below 50% health.")
		)
	var/gun_cooldown
	var/gun_cooldown_time = 1 SECONDS
	var/build_up = 0.8
...
/obj/item/ego_weapon/shield/gasharpoon
	...
	var/list/weapon_list = list(
		...
		"starbuck" = list(25, 1, 1, 'sound/weapons/ego/gasharpoon_starbuckhit.ogg', "Your burn the E.G.O of your first mate."),
		"queeqeg" = list(25, 1.6, 2, 'sound/weapons/ego/gasharpoon_queehit.ogg', "You burn the E.G.O of the indominable harpooneer.")
		)
