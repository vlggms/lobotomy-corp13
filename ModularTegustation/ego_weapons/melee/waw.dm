...
/obj/item/ego_weapon/hyde/proc/SwitchForm(mob/living/carbon/human/user)
	var/list/armament_icons = list(
		"red" = image(icon = 'ModularTegustation/Teguicons/lc13_coloreffect.dmi', icon_state = "red"),
		"white"  = image(icon = 'ModularTegustation/Teguicons/lc13_coloreffect.dmi', icon_state = "white"),
		"black"  = image(icon = 'ModularTegustation/Teguicons/lc13_coloreffect.dmi', icon_state = "black"),
	)
